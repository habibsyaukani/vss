...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'HOWEN VSS'); ?></title>
...
<body>
    ...
    <div class="navbar-top">
        <!-- Brand -->
        <a href="<?php echo e(route('frontend.dashboard')); ?>" class="navbar-brand-vss">
        ...
        <div class="navbar-right">
            <div><i class="far fa-calendar-alt me-1"></i> <?php echo e(date('d M Y')); ?></div>
            ...
            <div class="dropdown">
                <div class="user-profile" data-bs-toggle="dropdown">
                    ...
                    <span><?php echo e(explode(' ', auth()->user()->name)[0]); ?> <i class="fas fa-caret-down ms-1"></i></span>
                </div>
                <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 mt-2">
                    <li>
                        <form action="<?php echo e(route('frontend.logout')); ?>" method="POST" class="m-0 p-0">
                            <?php echo csrf_field(); ?>
