...
<div class="container-fluid">
    <div class="row mb-3">
        ...
        <div class="col-md-4 text-end">
            <a href="<?php echo e(route('admin.device.create')); ?>" class="btn btn-primary me-2">
                <i class="fas fa-plus"></i> Add Device
            </a>
            <a href="<?php echo e(route('admin.device.import-form')); ?>" class="btn btn-success">
...
$(function() {
    ...
    console.log('AJAX URL:', "<?php echo e(route('admin.device.data')); ?>");
    ...
    const table = $('.datatable').DataTable({
        ...
        scrollX: true,
        ajax: {
            url: "<?php echo e(route('admin.device.data')); ?>",
            data: function(d) {
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\project\vss\idle-monitor\resources\views/admin/device/index.blade.php ENDPATH**/ ?>