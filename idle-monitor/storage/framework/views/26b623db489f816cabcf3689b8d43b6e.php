<?php $__env->startSection('title', 'Speed Monitoring'); ?>
    ...
    <ul class="tree-view">
        <li class="tree-item">
            <div class="tree-parent open">
                ...
                <span class="group-count">(<?php echo e($totalDevices); ?>|<span style="color: #4ade80; font-weight: 700;"><?php echo e($totalActive); ?></span>)</span>
            </div>
                ...
                <?php $__currentLoopData = $deviceGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupName => $groupData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="tree-item">
                        <div class="tree-parent">
                            ...
                            ?>
                            <i class="fas <?php echo e($icon); ?> group-icon" style="color: #0d9488;"></i>
                            <span style="font-weight: 700; color: #cbd5e1;"><?php echo e($groupName); ?></span>
                            <span class="group-count">(<?php echo e($groupData['total']); ?>|<span style="color: #4ade80; font-weight: 700;"><?php echo e($groupData['active']); ?></span>)</span>
                        </div>
                        <ul class="tree-children">
                            <?php $__currentLoopData = $groupData['devices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="tree-child" data-device-name="<?php echo e(strtolower($device->device_name)); ?>" data-location="<?php echo e($device->lokasi ?? ''); ?>" data-series="<?php echo e($device->series ?? ''); ?>">
                                    ...
                                    ?>
                                    <i class="fas <?php echo e($dIcon); ?> group-icon me-2" style="color: <?php echo e($iconColor); ?>; font-size: 11px;"></i>
...
<div class="top-filter-row">
    <div class="filter-group-date">
        ...
        <input type="date" id="filterDate" class="date-input" value="<?php echo e(date('Y-m-d')); ?>">
    </div>
...
<div class="table-container" style="position: relative;">
    ...
    <div class="skeleton-overlay" id="tableSkeleton">
        <?php for($i=0; $i<10; $i++): ?>
            <div class="skeleton-row" style="width: <?php echo e(rand(80, 100)); ?>%;"></div>
        <?php endfor; ?>
    </div>
...
$(function() {
    ...
    let table = $('#speedTable').on('error.dt', function(e, settings, techNote, message) {
        ...
        ajax: {
            url: '<?php echo e(route('frontend.speed.data')); ?>',
            type: 'POST',
            headers: {
    ...
    function triggerExport(extraData) {
        ...
        let url = "<?php echo e(route('frontend.speed.export')); ?>";
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\project\vss\idle-monitor\resources\views/frontend/speed/index.blade.php ENDPATH**/ ?>