<?php $__env->startSection('title', 'Fleet Dashboard'); ?>
...
<div class="sidebar-top-section">
    ...
    <?php $rankColors = ['rank-gold','rank-silver','rank-bronze','rank-blue','rank-blue']; ?>
    <?php $__empty_1 = true; $__currentLoopData = $topSpeedUnits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="sidebar-top-item">
            <div class="sidebar-top-rank <?php echo e($rankColors[$i] ?? 'rank-blue'); ?>"><?php echo e($i + 1); ?></div>
            <div class="sidebar-top-name" title="<?php echo e($unit->device_name); ?>"><?php echo e($unit->device_name); ?></div>
            <div class="sidebar-top-value speed"><?php echo e($unit->max_speed); ?><small style="font-weight:500;color:#94a3b8;"> km/h</small></div>
        </div>
...
<div class="sidebar-top-section">
    ...
    <?php $__empty_1 = true; $__currentLoopData = $topIdleUnits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="sidebar-top-item">
            <div class="sidebar-top-rank <?php echo e($rankColors[$i] ?? 'rank-blue'); ?>"><?php echo e($i + 1); ?></div>
            <div class="sidebar-top-name" title="<?php echo e($unit->device_name); ?>"><?php echo e($unit->device_name); ?></div>
            <div class="sidebar-top-value idle"><?php echo e($unit->event_count); ?><small style="font-weight:500;color:#94a3b8;"> alarm</small></div>
        </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        <div style="font-size:12px;color:#94a3b8;text-align:center;padding:8px 0;">Belum ada data hari ini</div>
    <?php endif; ?>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo e($stats['today_idle_count']); ?></div>
                <div class="stat-desc"><i class="fas fa-arrow-up"></i> Hari Ini (<?php echo e(date('d M Y')); ?>)</div>
            </div>
        </div>
...
new Chart(idlePerFleetCtx, {
    type: 'doughnut',
    data: {
        labels: <?php echo json_encode($idlePerFleet['labels']); ?>,
        datasets: [{
            data: <?php echo json_encode($idlePerFleet['counts']); ?>,
    ...
    options: {
        ...
        plugins: {
            centerText: {
                value: '<?php echo e(array_sum($idlePerFleet["counts"])); ?>',
                label: 'TOTAL'
            },
            legend: {
                display: true,
...
const speedLabels = <?php echo json_encode($speedPerFleet['labels']); ?>;
const speedCounts = <?php echo json_encode($speedPerFleet['counts']); ?>;
...
new Chart(speedPerFleetCtx, {
    ...
    options: {
        ...
        plugins: {
            centerText: {
                value: speedLabels.length > 0 ? '<?php echo e(count($speedPerFleet["counts"]) > 0 ? max($speedPerFleet["counts"]) : 0); ?>' : '',
...
new Chart(trendSpeedCtx, {
    type: 'bar',
    data: {
        labels: <?php echo json_encode($speedPerDay['days']); ?>,
        datasets: [{
            label: 'Max Speed',
            data: <?php echo json_encode($speedPerDay['counts']); ?>,
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\project\vss\idle-monitor\resources\views/frontend/dashboard.blade.php ENDPATH**/ ?>