        ...
        <div class="card-body">
            ...
            <div class="row align-items-center mb-3">
                ...
                <div class="col-md-8">
                    <div class="alert alert-info mb-0">
                        ...
                        <strong>How it works:</strong> Keeps last <strong><?php echo e($cleanupSettings['cleanup_retention_days']); ?> days</strong> of data, deletes older data.<br>
                        <strong>Example:</strong> Today is <?php echo e(now()->format('d M Y')); ?> → Data before <?php echo e(now()->subDays($cleanupSettings['cleanup_retention_days'])->format('d M Y')); ?> will be deleted.<br>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="cleanup_schedule" class="form-control">
                                <option value="daily" <?php echo e($cleanupSettings['cleanup_schedule'] === 'daily' ? 'selected' : ''); ?>>Daily (Every day at 02:00 AM)</option>
                                <option value="weekly" <?php echo e($cleanupSettings['cleanup_schedule'] === 'weekly' ? 'selected' : ''); ?>>Weekly (Every Sunday at 02:00 AM)</option>
                                <option value="monthly" <?php echo e($cleanupSettings['cleanup_schedule'] === 'monthly' ? 'selected' : ''); ?>>Monthly (Every 1st of month at 02:00 AM)</option>
                            </select>
                            <small class="form-text text-muted">
            ...
            <div class="mt-4">
                ...
                <div class="alert alert-warning">
                    <strong><i class="fas fa-calendar-times"></i> Cutoff Date:</strong> <span id="cutoffDate"><?php echo e($cleanupStats['cutoff_date']); ?></span><br>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="alert alert-warning">
                ...
                <strong>Example:</strong> Today is <?php echo e(now()->format('d M Y')); ?> → You can cleanup months before <?php echo e(now()->subDays(2)->format('F Y')); ?>.
            </div>
...
$(document).ready(function() {
    ...
    function loadAvailableMonths() {
        $.get('<?php echo e(route("admin.system-control.months.available")); ?>')
            .done(function(data) {
    ...
    $('#btnPreviewMonth').on('click', function() {
        ...
        $.ajax({
            url: '<?php echo e(route("admin.system-control.months.preview")); ?>',
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
    ...
    $('#btnDeleteMonth').on('click', function() {
        ...
        $.ajax({
            url: '<?php echo e(route("admin.system-control.months.cleanup")); ?>',
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
