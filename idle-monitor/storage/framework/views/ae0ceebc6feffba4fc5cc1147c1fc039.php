<?php $__env->startSection('title', 'Speed Performance'); ?>
    ...
    <ul class="tree-view">
        <li class="tree-item">
            <div class="tree-parent open">
                ...
                <span class="group-count" id="totalDeviceCount">(<?php echo e($totalDevices); ?>|<span style="color: #4ade80; font-weight: 700;"><?php echo e($totalActive); ?></span>)</span>
            </div>
                    ...
                    <li class="tree-item">
                        ...
                        <ul class="tree-children">
                            <?php $__currentLoopData = $groupData['devices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="tree-child" data-device-name="<?php echo e(strtolower($device->device_name)); ?>" data-location="<?php echo e($device->location ?? ''); ?>" data-series="<?php echo e($device->series ?? ''); ?>">
...
$(document).ready(function() {
    ...
    function initTable() {
        ...
        table = $('#performanceTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('frontend.speed-performance.data')); ?>",
                type: 'POST',
                headers: {
    ...
    function doExport(exportType) {
        ...
        let form = $('<form>', {
            action: "<?php echo e(route('frontend.speed-performance.export')); ?>",
            method: 'POST'
        });
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\project\vss\idle-monitor\resources\views\frontend\speed-performance\index.blade.php ENDPATH**/ ?>