...
<div class="filter-section px-4 py-3">
    ...
    <select class="form-select form-select-sm" id="seriesFilter">
        ...
        <?php $__currentLoopData = $seriesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $series): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($series); ?>"><?php echo e($series); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </select>
</div>
                    ...
                    <li class="tree-item">
                        ...
                        <ul class="tree-children">
                            <?php $__currentLoopData = $groupData['devices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="tree-child" data-location="<?php echo e($device->lokasi ?? ''); ?>" data-series="<?php echo e($device->series ?? ''); ?>">
