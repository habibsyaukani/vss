...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?> - Idle Monitor System</title>
    ...
    <div class="sidebar">
        ...
        <div style="padding: 10px 20px; display: flex; align-items: center; gap: 12px; margin-bottom: 10px;">
            ...
            <div style="overflow: hidden;">
                <div style="font-size: 14px; font-weight: 600; color: #111827; white-space: nowrap; text-overflow: ellipsis;"><?php echo e(auth()->user()->name); ?></div>
                <div style="font-size: 12px; color: #6b7280;">Administrator</div>
            </div>
        </div>
        
        <div class="sidebar-section">MENU</div>
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link <?php echo e(Route::currentRouteName() === 'admin.dashboard' ? 'active' : ''); ?>">
            <i class="fas fa-home"></i> Dashboard
        </a>
        <a href="<?php echo e(route('admin.user.index')); ?>" class="nav-link <?php echo e(Route::currentRouteName() === 'admin.user.index' ? 'active' : ''); ?>">
            <i class="fas fa-users"></i> User Management
        </a>
        <a href="<?php echo e(route('admin.device.index')); ?>" class="nav-link <?php echo e(Route::currentRouteName() === 'admin.device.index' ? 'active' : ''); ?>">
            <i class="fas fa-car"></i> Device Management
        </a>
        <a href="<?php echo e(route('admin.import-log.index')); ?>" class="nav-link <?php echo e(Route::currentRouteName() === 'admin.import-log.index' ? 'active' : ''); ?>">
            <i class="fas fa-history"></i> Import Logs
        </a>
        <a href="<?php echo e(route('admin.data-pull.index')); ?>" class="nav-link <?php echo e(Route::currentRouteName() === 'admin.data-pull.index' ? 'active' : ''); ?>">
            <i class="fas fa-download"></i> Data Pull (Idle)
        </a>
        <a href="<?php echo e(route('admin.gps-track-pull.index')); ?>" class="nav-link <?php echo e(Route::currentRouteName() === 'admin.gps-track-pull.index' ? 'active' : ''); ?>">
            <i class="fas fa-map-marked-alt"></i> GPS Track Pull
        </a>
        <a href="<?php echo e(route('admin.auto-data-pull.index')); ?>" class="nav-link <?php echo e(Route::currentRouteName() === 'admin.auto-data-pull.index' ? 'active' : ''); ?>">
            <i class="fas fa-sync-alt"></i> Auto Data Pull
        </a>
        
        <div class="sidebar-section mt-3">SYSTEM</div>
        <a href="<?php echo e(route('admin.system-health.index')); ?>" class="nav-link <?php echo e(Route::currentRouteName() === 'admin.system-health.index' ? 'active' : ''); ?>">
            <i class="fas fa-heartbeat"></i> System Health
        </a>
        <a href="<?php echo e(route('admin.system-setting.index')); ?>" class="nav-link <?php echo e(Route::currentRouteName() === 'admin.system-setting.index' ? 'active' : ''); ?>">
        ...
        <div style="padding: 0 20px; margin-top: 10px;">
            ...
            <form id="logoutForm" action="<?php echo e(route('admin.logout')); ?>" method="POST" style="display: none;">
                <?php echo csrf_field(); ?>
            </form>
        </div>
        ...
        <div style="font-size: 11px; color: #9ca3af; padding: 10px 20px; text-align: center;">
            &copy; <?php echo e(date('Y')); ?> Idle Monitor Backend
        </div>
    </div>
