    ...
    <div class="sidebar-list mb-4">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $topSpeedUnits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="sidebar-item">
                <div class="sidebar-rank <?php echo e($rankColors[$i] ?? 'rank-blue'); ?>"><?php echo e($i + 1); ?></div>
                <div class="sidebar-name" title="<?php echo e($unit->device_name); ?>"><?php echo e($unit->device_name); ?></div>
                <div class="sidebar-value red"><?php echo e($unit->max_speed); ?><span>km/h</span></div>
            </div>
    ...
    <div class="sidebar-list">
        <?php $__empty_1 = true; $__currentLoopData = $topIdleUnits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="sidebar-item">
                <div class="sidebar-rank <?php echo e($rankColors[$i] ?? 'rank-blue'); ?>"><?php echo e($i + 1); ?></div>
                <div class="sidebar-name" title="<?php echo e($unit->device_name); ?>"><?php echo e($unit->device_name); ?></div>
                <div class="sidebar-value blue"><?php echo e($unit->event_count); ?><span>alarm</span></div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div style="font-size:12px;color:#94a3b8;text-align:center;">Belum ada data</div>
        <?php endif; ?>
        ...
        <div class="col-lg-4">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-desc">
                        <span class="trend-up"><i class="fas fa-arrow-up"></i> 12%</span> dari <?php echo e(date('d M Y')); ?>
        ...
        <div class="col-lg-4">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-value-row">
                        <div class="stat-value" style="color:#22c55e;"><?php echo e($stats['max_speed']); ?></div>
        ...
        <div class="col-lg-4">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-value-row">
                        <div class="stat-value" style="color:#f97316;"><?php echo e($stats['avg_speed']); ?></div>
                        <div class="stat-unit">km/h</div>
                    </div>
                    <div class="stat-desc">
...
const idleLabels = <?php echo json_encode($idlePerFleet['labels']); ?>;
const idleCounts = <?php echo json_encode($idlePerFleet['counts']); ?>;
