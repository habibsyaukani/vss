...
<?php $__env->startSection('title', 'System Health Check'); ?>
...
<div class="container-fluid">
    ...
    <div class="top-stats-row">
        ...
        <div class="health-score-card">
            <div class="health-status-badge status-<?php echo e($status); ?>">
            ...
            <div class="last-checked-text">
                Last: <span id="lastChecked"><?php echo e(now()->format('H:i:s')); ?></span>
            </div>
        </div>
        ...
        <div class="stat-card success">
            ...
            <div class="stat-value"><?php echo e($healing_stats['successful']); ?></div>
        ...
        <div class="stat-card failed">
            ...
            <div class="stat-value"><?php echo e($healing_stats['failed']); ?></div>
        ...
        <div class="stat-card rate">
            ...
            <div class="stat-value"><?php echo e($healing_stats['success_rate']); ?>%</div>
    ...
    <div class="checks-grid">
        <?php $__currentLoopData = $checks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $checkName => $check): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="check-card">
            <div class="check-icon <?php echo e(strtolower($check['status']) === 'ok' ? 'ok' : (strtolower($check['status']) === 'warning' ? 'warning' : 'error')); ?>">
                <?php if(strtolower($check['status']) === 'ok'): ?>
                    <i class="fas fa-check"></i>
                <?php elseif(strtolower($check['status']) === 'warning'): ?>
                    <i class="fas fa-exclamation-triangle"></i>
                <?php else: ?>
            ...
            <div class="check-content">
                <div class="check-title"><?php echo e(ucwords(str_replace('_', ' ', $checkName))); ?></div>
                <div class="check-message"><?php echo e($check['message']); ?></div>
                <div class="check-details"><?php echo e($check['details']); ?></div>
            </div>
        </div>
    ...
    <div class="collapsible-section">
        <div class="collapsible-header active" onclick="toggleCollapsible(this)">
            <div class="collapsible-title">
                ...
                Critical Issues
                <span class="collapsible-badge"><?php echo e(count($issues)); ?></span>
            </div>
                ...
                <div class="issues-list">
                    ...
                    <div class="issue-card">
                        <div class="issue-header">
                            <div class="issue-icon"><?php echo e(substr($issue['title'], 0, 2)); ?></div>
                            <div class="issue-content">
                                <div class="issue-title"><?php echo e($issue['title']); ?></div>
                                <div class="issue-message"><?php echo e($issue['message']); ?></div>

                                <?php if(isset($issue['healable']) && $issue['healable']): ?>
                                <div class="issue-actions">
                                    <button class="heal-btn" onclick="manualHeal('<?php echo e($issue['issue_type']); ?>')">
                                ...
                                <div class="troubleshooting-box">
                                    ...
                                    <ul class="troubleshooting-steps">
                                        <?php $__currentLoopData = $issue['troubleshooting']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="collapsible-section">
        <div class="collapsible-header" onclick="toggleCollapsible(this)">
            <div class="collapsible-title">
                ...
                Warnings
                <span class="collapsible-badge warning"><?php echo e(count($warnings)); ?></span>
            </div>
            <i class="fas fa-chevron-down collapsible-icon"></i>
        </div>
                ...
                <div class="issues-list">
                    ...
                    <div class="issue-card warning">
                        <div class="issue-header">
                            ...
                            <div class="issue-content">
                                <div class="issue-title"><?php echo e($warning['title']); ?></div>
                                <div class="issue-message"><?php echo e($warning['message']); ?></div>

                                <?php if(isset($warning['healable']) && $warning['healable']): ?>
                                <div class="issue-actions">
                                    <button class="heal-btn" onclick="manualHeal('<?php echo e($warning['issue_type']); ?>')">
                                        <i class="fas fa-magic"></i> Auto-Heal Issue
                                    </button>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="troubleshooting-box">
                                    ...
                                    <ul class="troubleshooting-steps">
                                        <?php $__currentLoopData = $warning['troubleshooting']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><?php echo e($step); ?></li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                </div>
    ...
    <?php if($table_exists && $healing_logs->count() > 0): ?>
    <div class="collapsible-section">
        <div class="collapsible-header" onclick="toggleCollapsible(this)">
            <div class="collapsible-title">
                <i class="fas fa-history" style="color: #5a5ced;"></i>
                Auto-Healing History
                <span class="collapsible-badge success"><?php echo e($healing_logs->count()); ?></span>
            </div>
            <i class="fas fa-chevron-down collapsible-icon"></i>
        </div>
        <div class="collapsible-content">
            <div class="collapsible-body">
                <div class="history-timeline">
                    <?php $__currentLoopData = $healing_logs->take(15); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="history-item">
                        <div class="history-item-icon <?php echo e($log->status); ?>">
                        ...
                        <div class="history-item-content">
                            <div class="history-item-header">
                                <div>
                                    <span class="history-item-title"><?php echo e(ucwords(str_replace('_', ' ', $log->issue_type))); ?></span>
                                    <span class="history-item-badge <?php echo e($log->status); ?>">
                                        <?php echo e(ucfirst($log->status)); ?>

                                    </span>
                                </div>
                                <div class="history-item-time"><?php echo e($log->created_at->diffForHumans()); ?></div>
                            </div>
                            <div class="history-item-problem"><?php echo e(Str::limit($log->problem_description, 80)); ?></div>
                            <div class="history-item-result">
                                <strong>Action:</strong> <?php echo e($log->healing_action); ?> 
                                <?php if($log->execution_time_ms): ?>
                                    • <strong><?php echo e($log->execution_time_ms); ?>ms</strong>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function runMigration() {
        ...
        fetch('<?php echo e(route('admin.system-health.migrate')); ?>', {
            method: 'POST',
            headers: {
    ...
    function manualHeal(issueType) {
        ...
        fetch('<?php echo e(route('admin.system-health.heal')); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
    ...
    // Initial draw
    drawHealthCircle(<?php echo e($health_score); ?>);

    // Refresh health check
    function refreshHealth() {
        document.getElementById('loadingOverlay').classList.add('show');

        fetch('<?php echo e(route('admin.system-health.check')); ?>')
            .then(response => response.json())
            .then(data => {
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\project\vss\idle-monitor\resources\views\admin\system-health.blade.php ENDPATH**/ ?>