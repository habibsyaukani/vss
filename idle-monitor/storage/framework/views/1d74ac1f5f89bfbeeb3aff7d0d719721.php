...
<?php $__env->startSection('title', 'GPS Track Pull'); ?>
        ...
        <div class="col-md-3">
            <div class="card bg-primary text-white">
                <div class="card-body">
                    ...
                    <h3 class="mb-0" id="stat-devices"><?php echo e(number_format($stats['total_devices'])); ?></h3>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="gpsTrackPullForm" data-execute-url="<?php echo e(route('admin.gps-track-pull.execute')); ?>" data-stats-url="<?php echo e(route('admin.gps-track-pull.statistics')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            <label for="date" class="form-label">Tanggal <span class="text-danger">*</span></label>
                            <input type="date" class="form-control" id="date" name="date" required value="<?php echo e(date('Y-m-d', strtotime('-1 day'))); ?>">
...
<script src="<?php echo e(asset('js/gps-track-pull.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\project\vss\idle-monitor\resources\views/admin/gps-track-pull.blade.php ENDPATH**/ ?>