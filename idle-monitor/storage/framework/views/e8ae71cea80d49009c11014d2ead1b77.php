...
<body>
    ...
    <div class="sidebar">
        <div class="p-3">
            ...
            <nav class="nav flex-column">
                ...
                <a class="nav-link" href="<?php echo e(route('admin.device.index')); ?>">
                    <span class="menu-icon"><i class="fas fa-car"></i></span>Device Management
                </a>
                <a class="nav-link" href="<?php echo e(route('admin.import-log.index')); ?>">
                    <span class="menu-icon"><i class="fas fa-history"></i></span>Import Logs
                </a>
                <a class="nav-link" href="<?php echo e(route('admin.data-pull.index')); ?>">
                    <span class="menu-icon"><i class="fas fa-download"></i></span>Data Pull
                </a>
                <a class="nav-link" href="<?php echo e(route('admin.system-setting.index')); ?>">
    ...
    <div class="main-content">
        ...
        <div class="row mb-4">
            <div class="col-md-2">
                <div class="stat-card">
                    <div class="stat-number"><?php echo e($stats['total_devices']); ?></div>
                    <div class="stat-label">Total Devices</div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="stat-card">
                    <div class="stat-number"><?php echo e($stats['total_idle_today']); ?></div>
                    <div class="stat-label">Idle Today</div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="stat-card">
                    <div class="stat-number"><?php echo e($stats['active_idle']); ?></div>
                    <div class="stat-label">Active Idle</div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="stat-card">
                    <div class="stat-number"><?php echo e(round($stats['avg_duration'])); ?></div>
            ...
            <div class="col-md-2">
                <div class="stat-card">
                    <div class="stat-number"><?php echo e($stats['active_users']); ?></div>
                    ...
                    <div class="card-body">
                        <div style="max-height: 400px; overflow-y: auto;">
                            <table class="table table-sm table-hover">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $topDevices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td><strong><?php echo e($device->device_name); ?></strong></td>
                                            <td><?php echo e($device->total_idle); ?></td>
                                            <td><?php echo e(round($device->total_duration, 0)); ?> min</td>
                                        </tr>
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $importLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($log->finished_at ? $log->finished_at->format('H:i') : '-'); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr>
...
<?php /**PATH G:\project\vss\idle-monitor\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>