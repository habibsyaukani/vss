...
new Chart(idleBarCtx, {
    ...
    data: {
        ...
        datasets: [{ label: 'Idle Alarm', data: <?php echo json_encode($idlePerDay['counts']); ?>, backgroundColor: '#3b82f6', borderRadius: 4, barThickness: 35 }]
    },
    options: {
...
fetch('<?php echo e(route("frontend.dashboard.speed-stats")); ?>')
    .then(r => r.json())
    .then(d => {
        // Update stat cards
